...
def populate_main_window(frm_main):
    ...
    lbl_age = Label(frm_main, text="radius of circle:")

    # Create an integer entry box where the user will enter her age.
    ent_radius = IntEntry(frm_main, width=4, lower_bound=0, upper_bound=10000)

    # Create a label that displays "years"
    lbl_age_units = Label(frm_main, text="meters")
    ...
    lbl_rate_units = Label(frm_main, text="meters")
    ...
    #lbl_age_units.grid(row=0, column=0, padx=0, pady=3)
    ...
    def calculate(event):
        ...
        try:
            ...
            lbl_slow.config(text=f"{area:.3f}")
