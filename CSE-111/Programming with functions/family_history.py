...
def main():
    ...
    # for item in print_death_age(people_dict):
    #     print(item[0], item[1])
...
def print_death_age(people_dict):
    ...
    for item in people_dict:
        name = people_dict[item][NAME_INDEX]
        death = people_dict[item][DEATH_YEAR_INDEX] - people_dict[item][BIRTH_YEAR_INDEX]
...
def count_genders(people_dict):
    ...
    for item in people_dict:
        gender = people_dict[item][GENDER_INDEX]
        if gender == "M":
            males += 1
...
def print_marriages(marriages_dict, people_dict):
    ...
    for item in marriages_dict:
        husband_key = marriages_dict[item][HUSBAND_KEY_INDEX]
        wife_key = marriages_dict[item][WIFE_KEY_INDEX]
        husband_name = people_dict[husband_key][NAME_INDEX]
        wife_name = people_dict[wife_key][NAME_INDEX]
        husband_wedding_age = marriages_dict[item][WEDDING_YEAR_INDEX] - people_dict[husband_key][BIRTH_YEAR_INDEX]
        wife_wedding_age = marriages_dict[item][WEDDING_YEAR_INDEX] - people_dict[wife_key][BIRTH_YEAR_INDEX]
        wedding_year = marriages_dict[item][WEDDING_YEAR_INDEX]

        print(f"{husband_name}: {husband_wedding_age}, {wife_name}: {wife_wedding_age} Wedding year: {wedding_year}")
