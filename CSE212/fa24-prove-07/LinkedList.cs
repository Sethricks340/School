...
public class LinkedList : IEnumerable<int> {
    ...
    public void RemoveLast() {
        if (_tail != null){
            _tail.Prev.Next = null; //set the next of the second to last node as nothing
    ...
    public void Remove(int value) {
        ...
        while (curr is not null) {
            if (curr.Data == value) {
                /* If the location of 'value' is at the end of the list,
                then we can remove the tail. Same with the head.*/
                if (curr == _head) RemoveFirst();
                else if (curr == _tail) RemoveLast();
                    
                // For any other location of 'value', need to remove in the middle
                else{
    ...
    public void Replace(int oldValue, int newValue) {
        ...
        return; // We can exit the function after we replace all the values
    }
    ...
    public IEnumerable Reverse() {
       ...
       while (curr is not null) {
           yield return curr.Data; // Go backwards in the linked list
           curr = curr.Prev; 
       }
    }
