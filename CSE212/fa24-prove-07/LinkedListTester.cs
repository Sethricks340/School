...
public static class LinkedListTester {
    public static void Run() {
        ...
        ll.AddFirst(2);
        ll.AddFirst(1);
        Console.WriteLine(ll.ToString()); // <LinkedList>{1 ,2, 3, 4, 100, 35, 10, 10}
        Console.WriteLine(ll.Reverse().AsString()); // <IEnumerable>{10, 10, 35, 100, 4, 3, 2, 1}
        
        Console.WriteLine("\n=========== PROBLEM 6 TESTS ===========");
        ll.Clear();
        Console.WriteLine(ll.ToString()); // <LinkedList>{}
        Console.WriteLine(ll.Reverse().AsString()); // <IEnumerable>{}
        ll.RemoveLast();
        Console.WriteLine(ll.ToString()); // <LinkedList>{}
        ll.Remove(1);
        Console.WriteLine(ll.ToString()); // <LinkedList>{}
