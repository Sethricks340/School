...
public static class TreesTester {
    ...
    public static void Run() {
        ...
        tree.Insert(14);
        tree.Insert(15);
        Console.WriteLine(tree.GetHeight()); // 8
        ...
        var tree7 = CreateTreeFromSortedList(Enumerable.Range(0, 13000).ToArray()); // logbase2(13000) = 13.7 or 14 levels min
        ...
        Console.WriteLine(tree7.GetHeight()); // 14
    ...
    {
        //only do this if last is not less than first, no matter where you are at
        if (first > last) return;
        //find current middle (works for all indexes)
