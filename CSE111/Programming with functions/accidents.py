...
def main():
    ...
    try: 
        ...
        print("Sorry, the value that you entered is not valid.")

    except ZeroDivisionError:
        print("Error: You divided by 0")
        print(f"{filename} contains a 0 in the fatal crashes column on line {reader.line_num}")

    #not a csv file, key in a dictionary doesn't exist
    except (csv.Error, KeyError):
        print("Error: There is an error in the csv file")
        print(f"{filename} contains an error on line {reader.line_num}")
