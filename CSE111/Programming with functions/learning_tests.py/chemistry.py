"""
This program allows the user to enter the amount of any formula. 
It then returns grams/mole, the number of moles, and the name of the compound,
if it is known (dictionary is limited)
-Seth Ricks 
CSE 111
"""
...
def main():
    ...
    print(f"{sample_mass / molar_mass:.5f} moles")
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for item in symbol_quantity_list:
        ...
        #find atomic mass of given element
        atomic_mass = value[ATOMIC_MASS_INDEX]

        #mass of the given elements
        partial_mass = atomic_mass * item[QUANTITY_INDEX]

        #add element masses together together
