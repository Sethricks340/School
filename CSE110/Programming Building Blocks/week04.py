...
#or
print('This is a string with .format formatting... {1:.2f} {0} {2:&>10}'.format((a + 5 * 23 - 12), b, "nice"))
...
force = mass * accel
print(f"{force=}")  # cool trick, outputs the name of the string and what it equals 
