...
const struct adc_sample_config sample_case[] = {
		{1,		7999,	9999},	//First #  in each line is the samples_per
		{2,		7999,	4999},	//Second # in each line is the prescaler
		{4,		7999,	2499},	//Third # in each line is the period
...
#define USE_HAL_DAC_REGISTER_CALLBACKS        1U
  ...
  HAL_TIM_Base_Start_IT(&htim6); // Period tracker
