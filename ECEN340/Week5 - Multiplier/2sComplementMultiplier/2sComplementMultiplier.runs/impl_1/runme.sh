...
HD_PWD='C:/Users/slricks340/Desktop/ECEN 340 Seth Ricks Ian Fleming/ECEN-340/Week5 - Multiplier/2sComplementMultiplier/2sComplementMultiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log twosComplementMult.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source twosComplementMult.tcl -notrace
