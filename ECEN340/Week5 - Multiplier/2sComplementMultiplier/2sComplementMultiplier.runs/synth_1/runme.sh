...
HD_PWD='C:/Users/slricks340/Desktop/ECEN 340 Seth Ricks Ian Fleming/ECEN-340/Week5 - Multiplier/2sComplementMultiplier/2sComplementMultiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log twosComplementMult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source twosComplementMult.tcl
